# Django Telegram Bot for summarization

Django + python-telegram-bot + Celery + Redis + Postgres + Dokku + GitHub Actions. Production-ready Telegram bot with database, admin panel and a bunch of useful built-in methods.
...
- Production-ready deployment using [Dokku](https://dokku.com)
...
- [How to run locally](https://github.com/Glazkoff/neuralite/#how-to-run)
  - [Quickstart with polling and SQLite](https://github.com/Glazkoff/neuralite/#quickstart-polling--sqlite)
  - [Using docker-compose](https://github.com/Glazkoff/neuralite/#run-locally-using-docker-compose)
- [Deploy to production](https://github.com/Glazkoff/neuralite/#deploy-to-production)
  - [Using dokku](https://github.com/Glazkoff/neuralite/#deploy-using-dokku-step-by-step)
  - [Telegram webhook](https://github.com/Glazkoff/neuralite/#https--telegram-bot-webhook)
...
```bash
git clone https://github.com/Glazkoff/neuralite
...
Go to file [.github/workflows/dokku.yml](https://github.com/Glazkoff/neuralite/blob/main/.github/workflows/dokku.yml):
